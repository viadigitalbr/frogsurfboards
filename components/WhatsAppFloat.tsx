...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-frog-green shadow-lg hover:scale-110 transition-transform"
    >
      <WhatsAppIcon />
    </a>
  );
...
function WhatsAppIcon() {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="#262626" aria-hidden="true">
