...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      <span
        className="font-heading text-base tracking-widest text-frog-ink whitespace-nowrap pr-4
...
function WhatsAppIcon() {
  return (
    <svg width="26" height="26" viewBox="0 0 448 512" fill="#262626" aria-hidden="true">
